...
- I have used react-router-dom for page routing purpose.
- My application contain three main parts.

```
PageHeader -> I have designed the DropDown menu in this section.
PageFooter -> I have given the all details related to page.
PageHome -> I have designed the whole components of the page.
```
