            ...
            <div class="row">
              <div class="col-lg-6 col-12 offset-lg-6 offset-md-6">
                <div class="slider-caption">
                  <span class="lead">Trending dress</span>
                  <h1 class="mt-2 mb-5">
                    <span class="text-color">Wear's </span>Collection
                  </h1>
            ...
            <div class="col-lg-3 col-12 col-md-6 col-sm-6 mb-5">
              <div class="product">
                ...
                <div class="product-info">
                  ...
                  <span class="price">Rs 450 – Rs 600</span>
                </div>
              </div>
            </div>
          ...
          <div class="row align-items-center">
            <div class="col-lg-6 offset-lg-6">
              <div class="ads-content">
                <span class="h5 deal">Deal of the day 60% Off</span>
                <h2 class="mt-3 text-white">Trending Suit</h2>
                <p class="text-md mt-3 text-white">
                  Hurry up! Limited time offer.Grab now!
                </p>
              ...
              <div class="widget-featured-entries mt-5 mt-lg-0">
                ...
                <div class="media mb-3">
                  ...
                  <div class="media-body">
                    ...
                    <p class="featured-entry-meta">Rs 299</p>
                  </div>
                </div>
                ...
                <div class="media mb-3">
                  ...
                  <div class="media-body">
                    ...
                    <p class="featured-entry-meta">Rs 355</p>
                  </div>
                </div>
                ...
                <div class="media mb-3">
                  ...
                  <div class="media-body">
                    ...
                    <p class="featured-entry-meta">Rs 399</p>
                  </div>
                </div>
                ...
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <p class="featured-entry-meta">Rs 499</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="widget-featured-entries mt-5 mt-lg-0">
                ...
                <div class="media mb-3">
                  ...
                  <div class="media-body">
                    ...
                    <p class="featured-entry-meta">Rs 599</p>
                  </div>
                </div>
