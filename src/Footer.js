          ...
          <div class="row">
            <div class="col-md-6 col-lg-4 col-sm-6 mb-5 mb-lg-0 text-center text-sm-left mr-auto">
              <div class="footer-widget">
                <h4 class="mb-4">E-Wears</h4>
                <p class="lead">All type items are avilable in this shop.</p>

                <div class="">
                  <p class="mb-0">
                    <strong>Location : </strong>HBTU Kanpur, INDIA
                  </p>
                  <p>
                    <strong>Support Email : </strong> prakhars418@gmail.com
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="row ">
            <div class="col-lg-6">
              <p class="copyright mb-0 ">
                @ Website &amp; made by{" Prakhar "}
                <a href="https://github.com/Prak1729">github</a>
              </p>
            </div>
            <div class="col-lg-6">
